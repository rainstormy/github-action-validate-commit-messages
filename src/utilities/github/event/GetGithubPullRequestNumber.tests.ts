...
`(
	...
	(props: { pullRequestNumber: number }) => {
...
describe("when the GitHub event payload is an illegal pull request #0", () => {
...
describe("when the GitHub event payload is not a pull request", () => {
	beforeEach(() => {
		mockEmptyGithubEventDto()
	})
