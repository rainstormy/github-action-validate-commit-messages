...
describe.each`
	...
	${"keep the audit trail warm\nsigned-off-by: casey jones <casey.jones@fastforward.com>"}                                                                                                                                                                       | ${[{ line: 0, range: [0, 13] }]}                                                           | ${[]}                                                         | ${[]}
	${"Calibrate the hot chocolate machine\nThe pressure now stays pleasantly dramatic.\n Signed-off-by:Michelangelo di Lodovico Buonarroti Simoni <28317649+cowabunga@users.noreply.github.com>"}                                                                 | ${[{ line: 1, range: [1, 14] }]}                                                           | ${[]}                                                         | ${[]}
	${"Document the pizza protocol\n\nFor the record, it goes like this:\n1. Invite everyone over for pizza and movie night.\n2. Order plenty of pizza, especially the legendary no. 12\n3. Have fun!!\n\n  SIGNED-OFF-BY:   Hamato Yoshi <hamato@nycsewers.com>"} | ${[{ line: 6, range: [2, 15] }]}                                                           | ${[]}                                                         | ${[]}
	${"triple-check the sign-off drawer\n\nsigned-off-by :  April O'Neil <april.oneil@fastforward.com>\nsigned-off-by:Casey Jones <casey.jones@fastforward.com>\nSIGNED-OFF-BY: Hamato Yoshi <hamato@nycsewers.com>"}                                              | ${[{ line: 1, range: [0, 13] }, { line: 2, range: [0, 13] }, { line: 3, range: [0, 13] }]} | ${[]}                                                         | ${[]}
	${"Pack the deploy snacks\n\nAcked-by: Casey Jones <casey.jones@fastforward.com>\nSigned-off-by: April O'Neil <april.oneil@fastforward.com>\nRelates-to: snack table"}                                                                                         | ${[{ line: 2, range: [0, 13] }]}                                                           | ${[]}                                                         | ${[]}
	${"one link and two notes\n\nsigned-off-by: april o'neil <april.oneil@fastforward.com>\nrefs: #668182\nchange-id: deadc0de"}                                                                                                                                   | ${[{ line: 1, range: [0, 13] }]}                                                           | ${[]}                                                         | ${[{ line: 2, range: [0, 4] }]}
	${"stamp the baseball\n\nChange-Id: cafebeef\nReviewed-by: April O'Neil <april.oneil@fastforward.com>\nSigned-off-by: Casey Jones <casey.jones@example.com>"}                                                                                                  | ${[{ line: 3, range: [0, 13] }]}                                                           | ${[]}                                                         | ${[{ line: 2, range: [0, 11] }]}
	${"release train part 1\n\nCo-authored-by: Copilot <223556219+Copilot@users.noreply.github.com>\nBREAKING CHANGE: The old seating chart is gone.\nSigned-off-by: April O'Neil <april.oneil@fastforward.com>"}                                                  | ${[{ line: 3, range: [0, 13] }]}                                                           | ${[{ line: 1, range: [0, 14] }, { line: 2, range: [0, 15] }]} | ${[{ line: 1, range: [0, 14] }]}
	${"Record the quiet acknowledgements\n\nBREAKING CHANGE:"}                                                                                                                                                                                                     | ${[]}                                                                                      | ${[{ line: 1, range: [0, 15] }]}                              | ${[]}
	${"Teach the build script a new trick\n\n breaking change: The old spell is gone."}                                                                                                                                                                            | ${[]}                                                                                      | ${[{ line: 1, range: [1, 16] }]}                              | ${[]}
	${"Break the old thing twice, politely\n\nBREAKING CHANGE: The old switch has left town.\nbreaking change: The old hallway is also closed."}                                                                                                                   | ${[]}                                                                                      | ${[{ line: 1, range: [0, 15] }, { line: 2, range: [0, 15] }]} | ${[]}
	${"Update src/main.ts\n\nCo-Authored-By: Everloving Easter Bunny <everloving.easter.bunny@example.com>"}                                                                                                                                                       | ${[]}                                                                                      | ${[{ line: 1, range: [0, 14] }]}                              | ${[{ line: 1, range: [0, 14] }]}
	${"Refine the button wobble\n\nThe wobble is now intentional.\n\nCO-AUTHORED-BY: Michelangelo di Lodovico Buonarroti Simoni <28317649+cowabunga@users.noreply.github.com>"}                                                                                    | ${[]}                                                                                      | ${[{ line: 3, range: [0, 14] }]}                              | ${[{ line: 3, range: [0, 14] }]}
	${"Wire the release breadcrumb trail\n\nReviewed-By: April O'Neil <april.oneil@fastforward.com>\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>\nSigned-Off-By: Hamato Yoshi <hamato@nycsewers.com>\nRefs: #123"}                                     | ${[{ line: 3, range: [0, 13] }]}                                                           | ${[{ line: 2, range: [0, 14] }]}                              | ${[{ line: 1, range: [0, 11] }, { line: 2, range: [0, 14] }, { line: 4, range: [0, 4] }]}
	${"link the quiet paperwork\n\nrefs: #123"}                                                                                                                                                                                                                    | ${[]}                                                                                      | ${[]}                                                         | ${[{ line: 1, range: [0, 4] }]}
	${"Upgrade `BadgePrinter`\n\nThe queue no longer panics.\n\n Refs: #1648\nRefs: GH-21523"}                                                                                                                                                                     | ${[]}                                                                                      | ${[]}                                                         | ${[{ line: 3, range: [1, 5] }, { line: 4, range: [0, 4] }]}
	${"line up the approval stamps\n\nRefs: https://github.com/rainstormy/comet/issues/38"}                                                                                                                                                                        | ${[]}                                                                                      | ${[]}                                                         | ${[{ line: 1, range: [0, 4] }]}
	${"handbook renewed\nthe checklist learned some manners\nREVIEWED-BY: Copilot <223556219+Copilot@users.noreply.github.com>"}                                                                                                                                   | ${[]}                                                                                      | ${[]}                                                         | ${[{ line: 1, range: [0, 11] }]}
	${"Credit the careful reviewers\n\nReviewed-by: April O'Neil <april.oneil@fastforward.com>\nReviewed-By: Raph <theraffaelloexperience@tmnt.com>\nReviewed-by: Donatello <42069849+gogogadget@users.noreply.github.com>"}                                       | ${[]}                                                                                      | ${[]}                                                         | ${[{ line: 1, range: [0, 11] }, { line: 2, range: [0, 11] }, { line: 3, range: [0, 11] }]}
`(
...
describe("when verifying a set of multiple commits and some commits contain restricted trailers", () => {
	...
	describe.each`
		...
		${enabled1} | ${[]}
		${enabled2} | ${[bodyLineConcern(rule, commits[1].sha, { line: 1, range: [0, 14] }), bodyLineConcern(rule, commits[5].sha, { line: 1, range: [0, 15] })]}
