...
describe("in the default configuration", () => {
	...
	describe.each`
		...
		${"amend!#59: Sneak in a funny easter egg"}                        | ${["amend!", issueLink("#59: "), "Sneak in a funny easter egg"]}
		...
		${"squash! Apply strawberry jam to make the code sweeter (#7044)"} | ${["squash! Apply strawberry jam to make the code sweeter", issueLink(" (#7044)")]}
		${"Make the user interface less chaotic [GL-11] #17 "}             | ${["Make the user interface less chaotic", issueLink(" [GL-11] "), issueLink("#17 ")]}
		${"squash! #12 Throw a tantrum (#34) #56 {GH-78} #90"}             | ${["squash!", issueLink(" #12 "), "Throw a tantrum", issueLink(" (#34) "), issueLink("#56 "), issueLink("{GH-78} "), issueLink("#90")]}
		${"fixup! Close #1337 by fixing the bug"}                          | ${["fixup! Close", issueLink(" #1337 "), "by fixing the bug"]}
...
describe("in a custom configuration with Jira-style issue links", () => {
	...
	describe.each`
		...
		${"amend!UNICORN-59: Sneak in a funny easter egg"}                                       | ${["amend!", issueLink("UNICORN-59: "), "Sneak in a funny easter egg"]}
		...
		${"squash! Apply strawberry jam to make the code sweeter (UNICORN-7044)"}                | ${["squash! Apply strawberry jam to make the code sweeter", issueLink(" (UNICORN-7044)")]}
		...
		${"squash! UNICORN-12 Throw a tantrum (UNICORN-34) UNICORN-56 {UNICORN-78} UNICORN-90"}  | ${["squash!", issueLink(" UNICORN-12 "), "Throw a tantrum", issueLink(" (UNICORN-34) "), issueLink("UNICORN-56 "), issueLink("{UNICORN-78} "), issueLink("UNICORN-90")]}
		${"fixup! Close UNICORN-1337 by fixing the bug"}                                         | ${["fixup! Close", issueLink(" UNICORN-1337 "), "by fixing the bug"]}
