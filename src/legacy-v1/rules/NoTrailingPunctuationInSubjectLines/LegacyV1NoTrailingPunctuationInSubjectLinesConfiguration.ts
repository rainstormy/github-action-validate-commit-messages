...
export const legacyV1NoTrailingPunctuationInSubjectLinesConfigurationSchema = object({
	whitelist: pipe(
		string(),
...
export type LegacyV1RawNoTrailingPunctuationInSubjectLinesConfiguration = InferInput<
	typeof legacyV1NoTrailingPunctuationInSubjectLinesConfigurationSchema
>

export type LegacyV1NoTrailingPunctuationInSubjectLinesConfiguration = InferOutput<
	typeof legacyV1NoTrailingPunctuationInSubjectLinesConfigurationSchema
>
