...
export const legacyV1AcknowledgedCommitterEmailAddressesConfigurationSchema = object({
	patterns: pipe(
		string(),
...
export type LegacyV1RawAcknowledgedCommitterEmailAddressesConfiguration = InferInput<
	typeof legacyV1AcknowledgedCommitterEmailAddressesConfigurationSchema
>

export type LegacyV1AcknowledgedCommitterEmailAddressesConfiguration = InferOutput<
	typeof legacyV1AcknowledgedCommitterEmailAddressesConfigurationSchema
>
