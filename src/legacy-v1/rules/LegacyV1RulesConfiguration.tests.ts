...
`(
	...
	(testRow: { rawRuleKeys: string; expectedRuleKeys: LegacyV1RuleKeys }) => {
...
`(
	...
	(testRow: { rawRuleKeys: string; expectedErrorMessage: string }) => {
...
function parseConfiguration(rawRuleKeys: string): LegacyV1RuleKeys {
	return parse(legacyV1RuleKeysConfigurationSchema, rawRuleKeys)
}

function formatRuleKeys(ruleKeys: Array<string>): string {
