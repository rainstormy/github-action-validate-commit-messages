...
export function legacyV1GetGithubActionsConfiguration(): LegacyV1Configuration {
	return parse(legacyV1ConfigurationSchema, {
		...
		acknowledgedAuthorEmailAddresses: {
			patterns: githubActionsStringInput("acknowledged-author-email-addresses--patterns"),
		},
		...
		acknowledgedCommitterEmailAddresses: {
			patterns: githubActionsStringInput("acknowledged-committer-email-addresses--patterns"),
		},
		acknowledgedCommitterNames: {
			patterns: githubActionsStringInput("acknowledged-committer-names--patterns"),
		},
		imperativeSubjectLines: {
			whitelist: githubActionsStringInput("imperative-subject-lines--whitelist"),
		},
		issueReferencesInSubjectLines: {
			...
			patterns: githubActionsStringInput("issue-references-in-subject-lines--patterns"),
		},
		limitLengthOfBodyLines: {
			maximumCharacters: githubActionsStringInput("limit-length-of-body-lines--max-characters"),
		},
		limitLengthOfSubjectLines: {
			maximumCharacters: githubActionsStringInput("limit-length-of-subject-lines--max-characters"),
		},
		noSquashCommits: {
			disallowedPrefixes: githubActionsStringInput("no-squash-commits--disallowed-prefixes"),
		},
		noTrailingPunctuationInSubjectLines: {
			whitelist: githubActionsStringInput("no-trailing-punctuation-in-subject-lines--whitelist"),
		},
	})
}
