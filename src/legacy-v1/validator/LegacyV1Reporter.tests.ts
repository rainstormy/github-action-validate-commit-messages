...
describe("when the configuration has default settings", () => {
	...
	describe("a report generated from three valid commits", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Make the program act like a clown" }),
			legacyV1DummyCommit({
				subjectLine: "Apply strawberry jam to make the code sweeter",
			}),
			legacyV1DummyCommit({ subjectLine: "Fix a typo" }),
		])
	...
	describe("a report generated from a valid commit and a commit with a decapitalised subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Have fun" }),
			legacyV1DummyCommit({ sha: "d15ea5e", subjectLine: "throw a tantrum" }),
		])
	...
	describe("a report generated from two commits with a decapitalised subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ sha: "badd06", subjectLine: "have fun" }),
			legacyV1DummyCommit({
				sha: "c0ffee",
	...
	describe("a report generated from a valid commit and a commit without an empty line between the subject line and body", () => {
		const report = validate([
			...
			legacyV1DummyCommit({ subjectLine: "Refactor the taxi module" }),
		])
	...
	describe("a report generated from a valid commit and a commit with a non-imperative subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ sha: "badf00d", subjectLine: "WIP for now" }),
			legacyV1DummyCommit({ subjectLine: "Use the newest data" }),
		])
	...
	describe("a report generated from four commits with a non-imperative subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ sha: "badf00d", subjectLine: "Yet another fix" }),
			legacyV1DummyCommit({ sha: "d15ea5e", subjectLine: "Formatting again" }),
			legacyV1DummyCommit({ sha: "c0ffee", subjectLine: "It works now" }),
			legacyV1DummyCommit({ sha: "d06f00d", subjectLine: "Lunch break" }),
		])
	...
	describe("a report generated from a valid commit and a commit with a body line that is too long", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Enforce server-side validation" }),
			legacyV1DummyCommit({
				sha: "c0ffee",
	...
	describe("a report generated from a valid commit and a commit with a single-word subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Adjust the procedure" }),
			legacyV1DummyCommit({ sha: "c0ffee", subjectLine: "Test" }),
		])
	...
	describe("a report generated from two commits with a single-word subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ sha: "0ff1ce", subjectLine: "Fix" }),
			legacyV1DummyCommit({ sha: "c0ffee", subjectLine: "Update" }),
		])
	...
	describe("a report generated from a valid commit and a commit with a co-author", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Make it right this time" }),
			legacyV1DummyCommit({
				sha: "d06f00d",
	...
	describe("a report generated from a valid commit and a revert of a revert commit", () => {
		const report = validate([
			legacyV1DummyCommit({
				subjectLine: 'Revert "Repair the soft ice machine"',
			}),
			legacyV1DummyCommit({
				sha: "c0ffee",
	...
	describe("a report generated from a valid commit and a squash commit", () => {
		const report = validate([
			...
			legacyV1DummyCommit({ subjectLine: "Release the robot butler" }),
		])
	...
	describe("a report generated from a valid commit and a commit with trailing punctuation in the subject line", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Organise the bookshelf" }),
			legacyV1DummyCommit({
				sha: "0ff1ce",
	...
	describe("a report generated from a valid commit and a commit with unexpected whitespace", () => {
		const report = validate([
			legacyV1DummyCommit({ subjectLine: "Hunt down the bugs" }),
			legacyV1DummyCommit({
				sha: "d06f00d",
				subjectLine: "Do it right this  time",
			}),
		])
	...
	describe("a report generated from three commits with unexpected whitespace", () => {
		const report = validate([
			legacyV1DummyCommit({ sha: "0ff1ce", subjectLine: " Do it over" }),
			legacyV1DummyCommit({ sha: "badf00d", subjectLine: "Bring it on  " }),
			legacyV1DummyCommit({
				sha: "d06f00d",
...
describe("when the configuration overrides 'issue-references-in-subject-lines--patterns' with GitHub-style issue references as prefix", () => {
	...
	describe("a report generated from a valid commit and a commit without an issue reference", () => {
		const report = validate([
			legacyV1DummyCommit({
				subjectLine: "#1 Make the program act like a clown",
			}),
			legacyV1DummyCommit({
				sha: "d06f00d",
				subjectLine: "Apply strawberry jam to make the code sweeter",
	...
	describe("a report generated from two commits without an issue reference", () => {
		const report = validate([
			legacyV1DummyCommit({
				sha: "cafebabe",
				subjectLine: "Update some dependencies",
			}),
			legacyV1DummyCommit({
				sha: "cafed00d",
