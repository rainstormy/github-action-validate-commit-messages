...
| `check`           | `c`   | Runs `check-actions`, `check-format`, `check-mise`, and `check-types`.                                                                                                                           |
...
| `check-mise`      | `cm`  | Verifies that the [mise-en-place](https://mise.jdx.dev) configuration file (`mise.toml`) is well-formatted.                                                                                      |
...
| `format-mise`     | `fm`  | Reformats the [mise-en-place](https://mise.jdx.dev) configuration file (`mise.toml`).                                                                                                            |
